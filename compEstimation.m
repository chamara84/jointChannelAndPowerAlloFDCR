...
noPred1 = load('./PredResults/NumSUs8React_update1slot.mat');
pred1 = load('./PredResults/NumSUs8Proact_update1slot.mat');
noPred2 = load('./PredResults/NumSUs8React_update5SlotNew.mat');
pred2 = load('./PredResults/NumSUs8Proact_update5slot.mat');
noPred3 = load('./PredResults/NumSUs8React_update10SlotNew.mat');
pred3 = load('./PredResults/NumSUs8Proact_update10Slot.mat');
...
legend ([plotNum(1),plotNum(2),plotNum(3),plotNum(4),plotNum(5),plotNum(6)],'W\Prediction every slot','With prediction every slot',...
    'W\Prediction every 5 slots','With prediction every 5 slots ','W\Prediction every 10 slots','With prediction every 10 slots ');
...
legend ([plotNum(1),plotNum(2),plotNum(3),plotNum(4),plotNum(5),plotNum(6)],'W\Prediction every slot','With prediction every slot',...
    'W\Prediction every 5 slots','With prediction every 5 slots ','W\Prediction every 10 slots','With prediction every 10 slots ');% plotNum(4)=plot(timeSlots/2:timeSlots/2+timeSlots*0.1,meanRateOfSus(timeSlots/2:timeSlots/2+timeSlots*0.1,8),'-.b');
...
legend ([plotNum(1),plotNum(2),plotNum(3),plotNum(4),plotNum(5),plotNum(6)],'W\Prediction every slot','With prediction every slot',...
    'W\Prediction every 5 slots','With prediction every 5 slots ','W\Prediction every 10 slots','With prediction every 10 slots ');title('Probability of PU Outage Vs. Threshold');
xlabel('Threshold');
