...
plotNum(2)=plot(thresholdVec,noPred2.meanSNROfPUs,'-or');
%plotNum(4)=plot(thresholdVec,pred2.meanSNROfPUs,'-.vr');
plotNum(3)=plot(thresholdVec,noPred3.meanSNROfPUs,'-sk');
%plotNum(6)=plot(thresholdVec,pred3.meanSNROfPUs,'-.+r');
legend ([plotNum(1),plotNum(2),plotNum(3)],'3 Pairs',...
    '5 Pairs',' 8 Pairs');
...
plotNum(2)=plot(thresholdVec,noPred2.meanRateOfSus,'-or');
%plotNum(4)=plot(thresholdVec,pred2.meanRateOfSus,'-.vr');
plotNum(3)=plot(thresholdVec,noPred3.meanRateOfSus,'-sk');
...
plotNum(2)=plot(thresholdVec,noPred2.outageProbability,'-or');
%plotNum(4)=plot(thresholdVec,pred2.outageProbability,'-.vr');
plotNum(3)=plot(thresholdVec,noPred3.outageProbability,'-sk');
...
plotNum(2)=plot(thresholdVec,noPred2.percentOfThresholdViolation,'-or');
%plotNum(4)=plot(thresholdVec,pred2.percentOfThresholdViolation,'-.vr');
plotNum(3)=plot(thresholdVec,noPred3.percentOfThresholdViolation,'-sk');
